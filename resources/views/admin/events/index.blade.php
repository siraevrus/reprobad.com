...
@section('content')
    <div class="flex justify-between" >
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Список событий</h1>
            ...
            @foreach($resources as $resource)
                <tr class="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="py-3 px-6 text-center">
                        <form method="post" action="{{ route('admin.events.destroy', $resource->id) }}" class="flex items-center justify-center gap-2">
                            @csrf
                            @method('DELETE')
                            <a href="{{ route('admin.events.edit', $resource->id) }}" class="text-blue-500 hover:text-blue-700">
                                <span class="material-icons">edit</span>
                            </a>
                            <a href="{{ route('admin.events.switch', $resource->id) }}" class="text-blue-500 hover:text-blue-700">
