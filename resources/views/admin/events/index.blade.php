        ...
        <table class="min-w-full border border-gray-200 hidden md:table">
            ...
            @foreach($resources as $resource)
                <tr class="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="py-3 px-6">
                        {{-- Изображение исключено из запроса для оптимизации памяти --}}
                        <div class="w-[120px] h-[80px] bg-gray-200 flex items-center justify-center text-gray-400 text-xs">Нет фото</div>
                    </td>
            ...
            @foreach($resources as $resource)
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center mb-4">
                        {{-- Изображение исключено из запроса для оптимизации памяти --}}
                        <div class="w-[80px] h-[80px] bg-gray-200 flex items-center justify-center text-gray-400 text-xs rounded mr-4">Нет фото</div>
                        <div>
