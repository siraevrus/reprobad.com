...
@section('content')
    <div x-data="app()">
        ...
        <h2 class="text-xl font-semibold text-gray-800 mb-4">{{ request()->segment(3) == 'create' ? 'Создать' : 'Изменить' }} вопрос - ответ</h2>
        <form action="#" method="POST" class="space-y-6" @submit.prevent="save">
            ...
            <div>@include('admin.components.textarea-input', ['title' => 'Текст', 'field' => 'content'])</div>
