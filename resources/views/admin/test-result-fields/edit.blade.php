        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" 
                          ...
                          rows="5" 
                          required
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $resource->description) }}</textarea>
