    ...
    <section class="section reprotest-about">
      ...
      <div class="container">
        <div class="reprotest-block rtb-advs">
          ...
          <p class="reprotest-p">*&nbsp;— Индекс биоэнергетического и&nbsp;гормонального баланса — это интегральный (обобщающий) показатель, который оценивает соотношение между уровнем энергетической активности организма (основной обмен, работа митохондрий, энергетический статус клеток) и&nbsp;уровнем гормональной активности (в&nbsp;первую очередь — стресс‑системы, гипоталамо‑гипофизарно‑надпочечниковой оси, половых и&nbsp;метаболических гормонов).</p>
        </div>
      </div>
    </section>
