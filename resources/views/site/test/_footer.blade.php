  <section class="footer-section">
    <div class="footer-container">
      ...
      <div class="footer-contacts">
        ...
        <div class="social-icons">
          @if(social_url('rutube'))
          <a href="{{ social_url('rutube') }}" target="_blank" class="social-link w-inline-block">
          ...
          <a href="{{ social_url('telegram') }}" target="_blank" class="social-link w-inline-block">
          ...
          @endif
          @if(social_url('ok'))
          <a href="{{ social_url('ok') }}" class="social-link w-inline-block">
            <div class="social-icon w-embed"><svg width="100%" height="100%" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          @endif
          @if(social_url('vk'))
          <a href="{{ social_url('vk') }}" target="_blank" class="social-link w-inline-block">
            <div class="social-icon w-embed"><svg width="100%" height="100%" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          @endif
          @if(social_url('dzen'))
          <a href="{{ social_url('dzen') }}" target="_blank" class="social-link w-inline-block">
            <div class="social-icon w-embed"><svg width="100%" height="100%" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="footer-menu">
        ...
        <a href="{{ url('/privacy') }}" target="_blank" class="footer-terms-link">Политика конфиденциальности в отношении персональных данных</a>
      </div>
    ...
    <div class="cookies-banner">
      <div class="cookies-wrap">
        <div class="cookies">
          <div class="cookies-text">Этот веб-сайт использует файлы cookies, чтобы обеспечить удобную работу пользователей с ним и функционаые возможности сайта. Нажимая &quot;Я принимаю&quot; вы соглашаетесь с <a href="{{ url('/privacy') }}" target="_blank" class="cookies-text-link">условиями использования файлов cookies</a>
          </div>
