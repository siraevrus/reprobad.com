            ...
            <div class="items-wrap gap-0">
                ...
                <div class="events-card">
                    ...
                    <div class="events-card-body">
                        ...
                        {{-- <a href="{{ route('site.events.show', $event->alias) }}" class="events-card-button w-buttonstyle="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a> --}}
                    </div>
                </div>
                @endforeach
            </div>
