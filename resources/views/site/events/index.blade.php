            ...
            <div class="items-wrap gap-0">
                ...
                <div class="events-card">
                    ...
                    <div class="events-card-body">
                        ...
                        @if($resource->image)
                        <img src="{{ $resource->image }}" loading="lazy" alt="" sizes="(max-width: 479px) 92vw, (max-width: 767px) 91vw, 27vw" srcset="{{ $resource->logo }} 500w, {{ $resource->image }} 800w, {{ $resource->image }} 1080w, {{ $resource->image }} 1440w" class="events-card-image">
                        @endif
