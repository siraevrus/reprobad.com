    ...
    <section class="section article-section">
        <div class="container">
            <div class="breadcrumbs">
                <a href="{{ route('site.articles.index') }}" data-nav="back" class="breadcrumb">&lt;- Статьи</a>
            </div>
                ...
                <div class="side">
                    ...
                    <div class="side-head">
                        ...
                        <div class="card side-card">
                            @if(isset($item->icon))
                            <div class="card-head"><img src="{{ public_asset($item->icon ?? '') }}" loading="lazy" alt="" class="card-icon"></div>
                            @endif
                            <div class="card-body">
