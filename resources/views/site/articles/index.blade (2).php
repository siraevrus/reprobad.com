                    ...
                    @if(in_array($idx, [0,1,2,3,4,5]))
                        <div class="news-card">
                            ...
                            <div class="news-card-footer">
                                <a href="{{ route($item->route_name ?? 'site.articles.show', $item->alias) }}" class="card-button w-buttonstyle="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a>
                ...
                <div class="items-wrap">
                    @foreach($similarByCategory as $item)
                        <div class="news-card">
                            ...
                            <div class="news-card-footer">
                                <a href="{{ route($item->route_name, $item->alias) }}" class="card-button w-buttonstyle="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a>
                                <div class="card-date-time">
                                    <div class="card-date">{{ $item->published_at }}</div>
                                    <div class="card-read"><img src="images/clock.svg" loading="lazy" alt="Часы" class="clock-icon">
                                        <div>{{ $item->time ?? '' }}</div>
