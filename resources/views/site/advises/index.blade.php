...
@section('content')
    ...
    <section class="section inner-section">
        <div class="container">
            ...
            <div class="similar-section" style="margin-top: 2rem; margin-bottom: 2rem;">
                    ...
                    @foreach($similarByCategory as $item)
                        ...
                        @else
                            <div class="card">
                                ...
                                @endif
                                <div class="card-body">
                                    <a href="{{ route($item->route_name, $item->alias) }}" class="card-title">{{ $item->title }}</a>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route($item->route_name, $item->alias) }}" class="card-link w-inline-block">
