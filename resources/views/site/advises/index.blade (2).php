                    ...
                    @if(in_array($idx, [0,1,2,3,4,5]))
                        <div class="news-card">
                            ...
                            <div class="news-card-footer">
                                <a href="{{ route($item->route_name ?? 'site.advises.show', $item->alias) }}" class="card-button w-buttonstyle="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a>
