...
<head>
    ...
    <link rel="alternate" type="text/plain" title="llms-full.txt" href="{{ url('/llms-full.txt') }}">
    ...
    @php
        ...
        $organization['parentOrganization'] = \App\Support\PostalAddressJsonLd::parentOrganization();
        ...
        $socialLinks = array_values(social_links());
    ...
    <style>
        ...
        html.w-mod-js body:not(.css-loaded){visibility:hidden;opacity:0}
    ...
    <div class="footer-container">
        ...
        <div class="footer-contacts">
            ...
            <div class="social-icons">
                ...
                <a href="{{ social_url('youtube') }}" class="social-link w-inline-block" rel="noopener noreferrer" target="_blank" aria-label="YouTube Система РЕПРО">
                ...
                <a href="{{ social_url('rutube') }}" class="social-link w-inline-block">
                    <div class="social-icon w-embed">
                ...
                <a href="{{ social_url('telegram') }}" class="social-link w-inline-block">
                    <div class="social-icon w-embed">
                ...
                @endif
                @if(social_url('vk'))
                <a href="{{ social_url('vk') }}" class="social-link w-inline-block">
                    <div class="social-icon w-embed">
                        <svg width="100%" height="100%" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                @endif
                @if(social_url('dzen'))
                <a href="{{ social_url('dzen') }}" class="social-link w-inline-block">
                    <div class="social-icon w-embed">
                        <svg width="100%" height="100%" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
