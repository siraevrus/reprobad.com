                        ...
                        <div class="product-item">
                            <div class="product-item-content">
                                ...
                                <div class="product-item-button-wrap">
                                    <a href="{{ route('site.complex.show', $resource->complex->alias) }}" class="button w-buttonstyle="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a>
                                </div>
                            </div>
                        </div>
                    @endif
