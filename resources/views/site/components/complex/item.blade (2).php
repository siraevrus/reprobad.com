<div class="step-item {{ $item->color }}"><img src="images/{{ $idx + 1 }}.svg" loading="lazy" alt="{{ $idx + 1 }}" class="step-item-number">
    <div class="step-item-content">
        ...
        <a href="{{ route('site.complex.show', $item->alias) }}" class="step-button {{ $item->color }} w-button" style="font-family: Inter, sans-serif;">Подробнее <span style="font-size: 2em; display: inline-block; line-height: 1; vertical-align: -0.15em;">→</span></a>
    </div>
