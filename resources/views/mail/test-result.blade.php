      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="width:600px;max-width:600px;">
        ...
        @php
          $advItems = [
              ...
              ['icon' => 'images/test/reprotest-ic-3.svg', 'title' => 'Очищение организма', 'text' => 'Нормализация кишечной микрофлоры и поддержка печени'],
              ['icon' => 'images/test/reprotest-ic-2.svg', 'title' => 'Общий метаболизм и углеводный обмен', 'text' => 'Коррекция энергетического обмена и&nbsp;нормализация метаболизма'],
              ...
              <tr>
                <td style="padding:24px;">
                  ...
                  <p style="margin:0 0 8px 0;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:15px;line-height:22px;color:#333333;font-weight:600;">
                    Программа подойдет и тем, кто не&nbsp;планирует беременность, но хочет, чтобы&nbsp;организм работал как&nbsp;часы.
                  </p>
                  <p style="margin:0 0 8px 0;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:14px;line-height:21px;color:#333333;">
                    Система РЕПРО – это программа, которая нормализует дефициты и помогает восстановить важные функции в&nbsp;организме женщины и мужчины, может повысить шансы на успешное зачатие, в&nbsp;том числе методом ЭКО.
                  </p>
        ...
        <tr>
          <td align="center" style="padding:0 20px 10px 20px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td align="center" valign="top" style="padding:0 10px;"><a target="_blank" href="https://rutube.ru/channel/48557140/?utm_term=testirovanie&utm_campaign=reproductivnoe_zdorovie&utm_medium=email&utm_source=site_test&utm_content=utm_email" style="text-decoration:none;"><img title="Rutube" src="{{ asset('storage/email/result/rutube.png') }}" alt="RT" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;"></a></td>
                <td align="center" valign="top" style="padding:0 10px;"><a target="_blank" href="https://t.me/reprobad?utm_term=testirovanie&utm_campaign=reproductivnoe_zdorovie&utm_medium=email&utm_source=site_test&utm_content=utm_email" style="text-decoration:none;"><img title="Telegram" src="{{ asset('storage/email/result/tg.png') }}" alt="Tg" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;"></a></td>
                <td align="center" valign="top" style="padding:0 10px;"><a target="_blank" href="https://ok.ru/group/70000030861851?utm_term=testirovanie&utm_campaign=reproductivnoe_zdorovie&utm_medium=email&utm_source=site_test&utm_content=utm_email" style="text-decoration:none;"><img title="Ok" src="{{ asset('storage/email/result/ok.png') }}" alt="Ok" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;"></a></td>
                <td align="center" valign="top" style="padding:0 10px;"><a target="_blank" href="https://vk.com/club228615718?utm_term=testirovanie&utm_campaign=reproductivnoe_zdorovie&utm_medium=email&utm_source=site_test&utm_content=utm_email" style="text-decoration:none;"><img title="VK" src="{{ asset('storage/email/result/vk.png') }}" alt="VK" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;"></a></td>
                <td align="center" valign="top" style="padding:0 10px;"><a target="_blank" href="http://dzen.ru/reprobad?utm_term=testirovanie&utm_campaign=reproductivnoe_zdorovie&utm_medium=email&utm_source=site_test&utm_content=utm_email" style="text-decoration:none;"><img title="Dzen" src="{{ asset('storage/email/result/dzen.png') }}" alt="DZ" height="32" width="33" style="display:block;border:0;outline:none;text-decoration:none;"></a></td>
              </tr>
            </table>
          </td>
        </tr>
