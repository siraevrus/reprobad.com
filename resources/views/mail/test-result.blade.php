      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="width:600px;max-width:600px;">
        ...
        @php
          $advItems = [
              ...
              ['icon' => 'images/test/reprotest-ic-2.svg', 'title' => 'Очищение организма', 'text' => 'Нормализация кишечной микрофлоры и поддержка печени'],
              ['icon' => 'images/test/reprotest-ic-3.svg', 'title' => 'Общий метаболизм и углеводный обмен', 'text' => 'Коррекция энергетического обмена и&nbsp;нормализация метаболизма'],
